...
cfonts.say('☠ ＭＯＮＫＥＹ Ｄ ＬＵＦＦＹ - ＭＤ 🏴‍☠', { 
  font: 'chrome',
  align: 'center',
  gradient: ['#d4af37', '#ff0000', '#00ff7f'], 
  transition: true,
  env: 'node'
})

cfonts.say('Developed By: ɴ͡ᴇ͜ɴᴇ❀᭄☂', {
  font: 'console',
  align: 'center',
  colors: ['yellowBright', 'redBright', 'greenBright']
})


console.log(chalk.magentaBright('☠ ＭＯＮＫＥＹ Ｄ ＬＵＦＦＹ - ＭＤ 🏴‍☠'))
